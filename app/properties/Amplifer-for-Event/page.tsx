...
// 🔊 Data untuk penyewaan Amplifier Event
const instrument = {
  id: 7,
  title: "Amplifier for Event",
  description:
    "Sewa amplifier profesional untuk berbagai acara seperti konser kecil, wedding, hingga event outdoor.\n\nSuara jernih, power besar, dan cocok untuk mendukung performa live music atau kebutuhan sound system event.",
  location: "Banyuwangi, Jawa Timur",
  address: "Jl. Wijaya Kusuma No.21, Banyuwangi, Jawa Timur",
  price: 250000,
  priceType: "day",
  type: "Rent",
  category: "Amplifier Event",
  features: [
    "Output power tinggi dengan suara jernih",
    "Dapat digunakan untuk indoor maupun outdoor",
    "Cocok untuk event musik, wedding, atau acara kampus",
    "Termasuk kabel & adaptor power",
  ],
  images: [
    "/images/amplifier1.jpg",
    "/images/amplifier2.jpg",
    "/images/amplifier3.jpg",
  ],
  contact: {
...
const initialComments = [
  {
    ...
    text: "Apakah amplifier ini cukup kuat untuk event di lapangan terbuka?",
    date: "Okt 22, 2025",
    time: "09:45 AM",
    replies: [
      {
        ...
        text: "Tentu! Amplifier ini mampu digunakan untuk event outdoor hingga 300 orang dengan hasil suara optimal.",
        date: "Okt 22, 2025",
        time: "10:00 AM",
      },
    ],
...
export default function RentAmplifierPage() {
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="relative aspect-video rounded-lg overflow-hidden">
            <Image
              ...
              alt={`Amplifier image ${currentImageIndex + 1}`}
              fill
