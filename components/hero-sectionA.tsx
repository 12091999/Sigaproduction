...
export default function HeroSection() {
  ...
  return (
    <section className="relative w-screen left-1/2 right-1/2 -mx-[50vw] overflow-hidden">
      ...
      <div className="absolute inset-0 animate-gradient bg-gradient-to-r from-blue-700 via-indigo-600 to-purple-600 bg-[length:400%_400%]"></div>
      ...
      <div className="relative z-10 py-16 md:py-24 lg:py-32 text-center text-white">
        <div className="container mx-auto px-3 md:px-4">
          ...
          <p className="text-sm sm:text-base md:text-xl text-white/90 max-w-3xl mx-auto mb-8 px-4">
            Your one-stop destination for Music Encyclopedia
          </p>
          ...
          >
            ...
            <div className="relative flex-1">
              <Input
                type="text"
                placeholder="Search for music, services, or offers..."
