...
import { Shirt, Music, Camera, Home, Menu, ShoppingCart, User, LogOut } from "lucide-react"
              ...
              {isLoggedIn ? (
                <>
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 py-2 text-base font-medium text-muted-foreground hover:text-red-600"
                  >
