...
// 🎹 Data alat musik untuk disewakan — KEYBOARD
const instrument = {
  id: 2,
  title: "Keyboard Yamaha PSR-SX700",
  description:
    "Sewa keyboard Yamaha PSR-SX700 untuk acara, latihan, atau recording.\n\nDilengkapi dengan ratusan suara instrumen, style otomatis, dan efek profesional. Cocok untuk pemain solo, band, atau event musik.",
  location: "Banyuwangi, Jawa Timur",
  address: "Jl. Wijaya Kusuma No.21, Banyuwangi, Jawa Timur",
  price: 200000,
  priceType: "day",
  type: "Rent",
  category: "Keyboard Elektronik",
  features: [
    "61 keys dengan sentuhan dinamis",
    "Layar berwarna dan navigasi mudah",
    "Output audio stereo berkualitas tinggi",
    "Tersedia stand & adaptor",
  ],
  images: [
...
const initialComments = [
  {
    id: 1,
    user: { name: "Rizky Aditya", avatar: "/placeholder.svg" },
    text: "Apakah keyboard ini bisa disewa dengan stand-nya juga?",
    date: "Okt 22, 2025",
    time: "09:45 AM",
    replies: [
      {
        ...
        text: "Tentu! Stand dan adaptor sudah termasuk dalam paket sewa.",
        date: "Okt 22, 2025",
        time: "10:10 AM",
      },
    ],
...
export default function RentKeyboardPage() {
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="relative aspect-video rounded-lg overflow-hidden">
            <Image
              ...
              alt={`Keyboard image ${currentImageIndex + 1}`}
              fill
